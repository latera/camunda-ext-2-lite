 ...
 * - <code>hydraDocumentAttachmentId</code> - Document file ID (*required*) /Long/
 *
 ...
 * - <code>hydraDocumentAttachmentDeleted</code> - Files attached to document  /Boolean/
 * /Boolean/
 */
class DeleteAttachmentProc : BaseProc() {
    ...
    override fun perform(execution: DelegateExecution) {
        ...
        val fileId = getLong(execution, "hydraDocumentAttachmentId")

        val deleted = doAction(restApi, documentId, fileId)
        setToExecution(execution, deleted)
    }
    ...
    fun doAction(
        ...
        return DocumentAttachment(restApi).delete(documentId, fileId)
    }
    ...
    private fun setToExecution(
        ...
        execution.setVariable(
            "hydraDocumentAttachmentDeleted",
            deleted
        )
    }
}
