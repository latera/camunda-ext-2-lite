...
import com.hydra_billing.vacation_request.Order as CurrentOrder

@ProcessApplication("vacation_request")
class VacationRequestApplication() : ServletProcessApplication() {
